...
# I commented out the automated device detection because it can cause troubles
# in situations where outdated cuda enabled devices are present. 
# Change device to "gpu" manually, in case you want to use GPUs
device = "cpu"
